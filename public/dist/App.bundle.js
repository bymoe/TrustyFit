...
function autocomplete(input, latInput, lngInput) {
  ...
  // if someone hit enter on the address field don't refresh.
...
function loadPlaces(map) {
  var lat = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 32.5377564;
  var lng = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 35.85531839;
...
function typeAhead(search) {
  ...
  searchInput.on("input", function () {
    ...
    if (!this.value) {
      search.searchResults.style.display = "none";
      return;
    }
...
var _geoLocate = __webpack_require__(12);
...
var directionButton = (0, _bling.$)(".single__contact.direction");
var mapButton = (0, _bling.$)(".single__map");
if (directionButton && mapButton) {
  directionButton.on("click", _geoLocate2.default);
  mapButton.on("click", _geoLocate2.default);
}
